    ...
    return (
        <Tooltip title={t('send-message')} side="top" sideOffset={0}>
            <button
                ...
                className="p-1 mr-2 rounded-md text-black dark:disabled:text-gray-800/40 enabled:text-gray-800 dark:enabled:text-black enabled:bg-black dark:enabled:bg-white disabled:text-gray-800/40 relative z-10"
            >
                {loading ? (
